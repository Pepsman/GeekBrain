...
def get_text(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        box = messagebox.showinfo("Победа!!", "Победил игрок 1")
    elif winner(board, "O"):
        gb.destroy()
        box = messagebox.showinfo("Победа!!", "Победил игрок 2")
    elif(isfull()):
        gb.destroy()
...
def get_text_pc(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Победа!!", "Победил игрок")
    elif winner(board, "O"):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Победа!!", "Победил компьютер")
    elif(isfull()):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Ничья", "Ничья")
...
def play():
    ...
    B1 = Button(menu, text="Игра против компьютера", command=wpc,
                activeforeground='red',
                activebackground="black", bg="red",
                fg="black", width=500, font='summer', bd=5)
    B2 = Button(menu, text="играть с другом", command=wpl, activeforeground='red',
